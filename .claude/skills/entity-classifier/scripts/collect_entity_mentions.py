...
# Add project scripts directory to path for config import
# This script is in .claude/skills/entity-classifier/scripts/
# We need to import config from scripts/ at project root
# Navigate: collect_entity_mentions.py → scripts → entity-classifier → skills → .claude → project_root
...
def main():
    ...
    parser.add_argument(
        '--entity-type',
        choices=['hotels', 'churches', 'schools', 'halls'],
    ...
    entity_names = {
        'hotels': [
            # Generic terms (leaf nodes for unspecified mentions)
            'Hotel', 'hotel', 'Family hotel', 'family hotel',
            # Specific named hotels
            ...
            'Mount Victoria Hotel', 'Grand Hotel', 'Falls Hotel', 'Comet Hotel',
            'Leura Hotel', 'Hotel Wentworth', 'Great Western Hotel', 'Hydora House Hotel',
            # Family hotels (specific)
            'Katoomba Family Hotel', "Fryer's Family Hotel", "Delaney's Family Hotel",
